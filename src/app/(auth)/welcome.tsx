      ...
      <View style={styles.page} testID="welcome-screen">
        ...
        >
          <View style={styles.brandMark}>
            ...
            <Text style={styles.brand}>invite</Text>
          </View>
          ...
          <View>
            ...
            <Text style={styles.subtitle}>
              Meet compatible people through coffee, walks, games, food, and the things you already
              love.
            </Text>
          </View>
        </LinearGradient>
        ...
        <View style={styles.content}>
            ...
            {benefits.map((benefit) => (
              <View key={benefit.text} style={styles.benefitRow}>
                <View style={styles.benefitIcon}>
                  <AppIcon name={benefit.icon} color={palette.forest} size={20} />
                </View>
          ...
          <Text style={styles.legal}>
            By continuing, you agree to be respectful, keep plans safe, and treat every invitation
            as optional.
          </Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  connector: {
    ...
    borderRadius: 60,
    borderWidth: 2,
    borderColor: 'rgba(49,92,76,0.22)',
  },
